...
angular
        .module('GtAdmin')
        .controller('AdminWebCtrl', AdminWebCtrl);


AdminWebCtrl.$inject = ['$scope', '$http', '$rootScope', '$location', '$timeout', 'confirmIfHasChanges', 'httpErrors'];

function AdminWebCtrl($scope, $http, $rootScope, $location, $timeout, confirmIfHasChanges, httpErrors) {
