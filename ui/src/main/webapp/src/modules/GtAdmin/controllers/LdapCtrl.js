...
angular
        .module('GtAdmin')
        .controller('AdminLdapCtrl', AdminLdapCtrl);


AdminLdapCtrl.$inject = ['$scope', '$http', 'confirmIfHasChanges', 'httpErrors'];

function AdminLdapCtrl($scope, $http, confirmIfHasChanges, httpErrors) {
