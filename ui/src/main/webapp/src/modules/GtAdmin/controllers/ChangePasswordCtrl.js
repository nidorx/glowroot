...
angular
        .module('GtAdmin')
        .controller('ProfileChangePasswordCtrl', ProfileChangePasswordCtrl);


ProfileChangePasswordCtrl.$inject = ['$scope', '$http', '$rootScope', '$location', 'confirmIfHasChanges', 'httpErrors'];

function ProfileChangePasswordCtrl($scope, $http, $rootScope, $location, confirmIfHasChanges, httpErrors) {
