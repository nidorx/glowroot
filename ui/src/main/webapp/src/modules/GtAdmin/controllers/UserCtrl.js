...
AdminUserCtrl.$inject = ['$scope', '$location', '$http', '$q', 'confirmIfHasChanges', 'httpErrors', 'modals'];

function AdminUserCtrl($scope, $location, $http, $q, confirmIfHasChanges, httpErrors, modals) {
