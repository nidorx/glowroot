...
angular
        .module('GtApp')
        .controller('ChartRangeCtrl', ChartRangeCtrl);


ChartRangeCtrl.$inject = ['$scope', '$location', 'queryStrings', 'charts', 'modals'];

function ChartRangeCtrl($scope, $location, queryStrings, charts, modals) {
