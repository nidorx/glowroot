...
angular
        .module('GtApp')
        .factory('confirmIfHasChanges', ConfirmIfHasChangesFactory);

ConfirmIfHasChangesFactory.$inject = ['$rootScope', '$location', 'modals'];

function ConfirmIfHasChangesFactory($rootScope, $location, modals) {
