...
angular
        ...
        .controller('TransactionFlameGraphCtrl', TransactionFlameGraphCtrl);


TransactionFlameGraphCtrl.$inject = ['$scope', '$location', '$http', 'httpErrors', 'queryStrings', 'model'];

function TransactionFlameGraphCtrl($scope, $location, $http, httpErrors, queryStrings, model) {
    // \u00b7 is &middot;
