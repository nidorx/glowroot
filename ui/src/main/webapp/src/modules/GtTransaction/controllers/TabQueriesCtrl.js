...
angular
        ...
        .controller('TransactionTabQueriesCtrl', TransactionTabQueriesCtrl);


TransactionTabQueriesCtrl.$inject = [
    '$scope', '$http', '$location', '$timeout', 'locationChanges', 'modals', 'queryStrings', 'httpErrors', 'model'
];

function TransactionTabQueriesCtrl($scope, $http, $location, $timeout, locationChanges,
        modals, queryStrings, httpErrors, model) {
