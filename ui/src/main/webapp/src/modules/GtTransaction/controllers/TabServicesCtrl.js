...
angular
        ...
        .controller('TransactionTabServicesCtrl', TransactionTabServicesCtrl);


TransactionTabServicesCtrl.$inject = [
    '$scope', '$http', '$location', 'locationChanges', 'modals', 'queryStrings', 'httpErrors', 'model'
];

function TransactionTabServicesCtrl($scope, $http, $location, locationChanges, modals,
        queryStrings, httpErrors, model) {
