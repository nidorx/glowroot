...
angular
        .module('GtConfig')
        .controller('ConfigPluginCtrl', ConfigPluginCtrl);


ConfigPluginCtrl.$inject = ['$scope', '$stateParams', '$http', '$location', 'confirmIfHasChanges', 'httpErrors', 'queryStrings'];

function ConfigPluginCtrl($scope, $stateParams, $http, $location, confirmIfHasChanges, httpErrors, queryStrings) {
