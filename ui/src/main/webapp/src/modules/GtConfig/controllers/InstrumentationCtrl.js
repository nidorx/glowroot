...
angular
        .module('GtConfig')
        .controller('ConfigInstrumentationCtrl', ConfigInstrumentationCtrl);


ConfigInstrumentationCtrl.$inject = [
    '$scope', '$location', '$http', '$rootScope', '$timeout', 'confirmIfHasChanges', 'httpErrors',
    'queryStrings', 'modals', 'instrumentationExport'];

function ConfigInstrumentationCtrl($scope, $location, $http, $rootScope, $timeout, confirmIfHasChanges, httpErrors, queryStrings, modals, instrumentationExport) {
