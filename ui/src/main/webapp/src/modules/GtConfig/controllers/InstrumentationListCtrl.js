...
angular
        .module('GtConfig')
        .controller('ConfigInstrumentationListCtrl', ConfigInstrumentationListCtrl);


ConfigInstrumentationListCtrl.$inject = [
    '$scope', '$location', '$http', '$timeout', '$q', 'locationChanges', 'queryStrings',
    'httpErrors', 'modals', 'instrumentationExport'];

function ConfigInstrumentationListCtrl($scope, $location, $http, $timeout, $q, locationChanges, queryStrings, httpErrors, modals, instrumentationExport) {
