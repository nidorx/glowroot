...
angular
        .module('GtConfig')
        .controller('ConfigUserRecordingCtrl', ConfigUserRecordingCtrl);


ConfigUserRecordingCtrl.$inject = ['$scope', '$http', '$rootScope', '$location', 'confirmIfHasChanges', 'httpErrors'];

function ConfigUserRecordingCtrl($scope, $http, $rootScope, $location, confirmIfHasChanges, httpErrors) {
