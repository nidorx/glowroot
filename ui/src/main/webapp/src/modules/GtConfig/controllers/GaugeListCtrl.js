...
angular
        .module('GtConfig')
        .controller('ConfigGaugeListCtrl', ConfigGaugeListCtrl);


ConfigGaugeListCtrl.$inject = ['$scope', '$location', '$http', 'queryStrings', 'httpErrors'];

function ConfigGaugeListCtrl($scope, $location, $http, queryStrings, httpErrors) {
