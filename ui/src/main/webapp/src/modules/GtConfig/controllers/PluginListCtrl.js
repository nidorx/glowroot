...
angular
        .module('GtConfig')
        .controller('ConfigPluginListCtrl', ConfigPluginListCtrl);


ConfigPluginListCtrl.$inject = ['$scope', '$location', '$http', 'queryStrings', 'httpErrors'];

function ConfigPluginListCtrl($scope, $location, $http, queryStrings, httpErrors) {
